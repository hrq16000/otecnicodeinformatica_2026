      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-accent/10 text-accent rounded-full px-4 py-2 mb-6 shimmer-sweep float-badge">
            ...
            <span className="text-sm font-medium">Atendimento local em Curitiba e região</span>
          </div>
          
          <img 
            alt="O Técnico de Informática" 
            className="h-16 md:h-20 mx-auto mb-7 motion-surface hover:shadow-lg duration-300" 
