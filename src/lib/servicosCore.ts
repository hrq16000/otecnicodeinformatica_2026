...
export const SERVICOS_CORE: Record<string, ServicoLandingData> = {
  ...
  "manutencao-de-notebook": {
    ...
    faqs: [
      ...
      { question: "SSD, memória, bateria ou tela estão incluídos no valor?", answer: "Não. Peças, componentes e materiais são tratados à parte do serviço e só são adquiridos após a sua aprovação. Informamos se o item é original, paralelo ou recondicionado." },
  ...
  "manutencao-de-computador": {
    ...
    faqs: [
      ...
      { question: "A manutenção do computador tem garantia?", answer: "Sim, conforme o serviço executado e a peça aplicada, nas condições publicadas na página de preços e políticas." },
    ],
    relacionados: [
      { label: "Formatação", to: "/servicos/formatacao" },
  ...
  "manutencao-preventiva-empresas": {
    ...
    faqs: [
      ...
      { question: "As peças trocadas durante a preventiva estão incluídas?", answer: "Não. Memória, SSD, fonte, ventoinha e demais componentes são tratados à parte. Quando a inspeção indica troca, informamos o motivo e o custo antes, e nada é substituído sem a sua autorização." },
