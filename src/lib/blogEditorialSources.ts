...
export const EDITORIAL_SOURCES: Record<string, EditorialSource> = {
  ...
  "ms-windows-setup-boot-start-driver": {
    ...
    sourceType: "official",
    supports: [
      "Quando o Windows Setup não localiza o disco ou a partição de destino, a mídia pode não conter o driver necessário para o dispositivo de armazenamento.",
      "Drivers de armazenamento podem precisar ser carregados durante a instalação para que o destino seja apresentado.",
    ],
  },
  "ms-win11-activation": {
...
export const ARTICLE_SOURCE_MANIFEST: Record<string, ArticleSourceManifest> = {
  ...
  "ssd-nao-aparece-no-instalador-do-windows": {
    ...
    sources: ["ms-win11-installation-media", "ms-windows-setup-boot-start-driver", "ms-bitlocker-recovery", "nvme-official-faq"],
    technicalReview: "reviewed",
    factChecked: true,
    factCheckedAt: "2026-09-25",
    notes:
      "Revisão material concluída em 2026-09-25 a partir de documentação oficial da Microsoft e NVM Express: separação entre firmware e Windows Setup, carregamento de driver de armazenamento, cautela com VMD/RST/AHCI, compatibilidade M.2/NVMe, UEFI/GPT, BitLocker e limite destrutivo do DiskPart. Sem promessa comercial e com sequência de parada diante de dados sem cópia.",
  },
