...
export const CLUSTER_PROBLEMAS: ClusterProblema[] = [
  {
    ...
    relacionados: [
      ...
      { to: "/glossario/dns", titulo: "O que é DNS (glossário)", desc: "Conecta mas nenhum site abre? Entenda o sistema que traduz nomes em endereços antes de culpar o sinal." },
  ...
  },
  {
    ...
    relacionados: [
      ...
      { to: "/glossario/bsod", titulo: "O que é BSOD (glossário)", desc: "O termo por trás da tela azul: o que o código de parada informa e o que anotar antes de reiniciar." },
  ...
  },
  {
    ...
    relacionados: [
      ...
      { to: "/glossario/recuperacao-de-dados", titulo: "O que é recuperação de dados (glossário)", desc: "Por que cada tentativa por conta própria reduz a chance de reaver os arquivos." },
  ...
  },
  {
    ...
    relacionados: [
      ...
      { to: "/glossario/smart", titulo: "O que é S.M.A.R.T. (glossário)", desc: "O automonitoramento do disco: quais atributos anunciam falha e como ler os sinais com segurança." },
      { to: "/problemas", titulo: "Outros sintomas", desc: "Volte ao hub e escolha o problema mais parecido com o seu." },
    ],
    foto: "bancada-tecnica",
  },
  ...
  },
  {
    ...
    relacionados: [
      ...
      { to: "/ferramentas/roteiro-falha-de-inicializacao", titulo: "Roteiro de falha de inicialização (ferramenta)", desc: "Checklist gratuito para anotar em que ponto a partida para antes de chamar o técnico." },
      { to: "/problemas", titulo: "Outros sintomas", desc: "Volte ao hub e escolha o problema mais parecido com o seu." },
    ],
    evidencia: {
  ...
  },
  {
    ...
    relacionados: [
      ...
      { to: "/glossario/thermal-throttling", titulo: "O que é thermal throttling (glossário)", desc: "A proteção que reduz o desempenho quando a temperatura sobe — e por que limpeza resolve." },
      { to: "/problemas", titulo: "Outros sintomas", desc: "Volte ao hub e escolha o problema mais parecido com o seu." },
    ],
  },
  {
