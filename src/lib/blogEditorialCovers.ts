...
export const EDITORIAL_COVERS: Record<string, EditorialCover> = {
  ...
  // ── Onda 5G — capas fotográficas reais licenciadas (sem IA).
  "como-instalar-impressora-windows-passo-a-passo": {
    src: "/blog/como-instalar-impressora-windows-passo-a-passo.jpg",
    alt: "Impressora jato de tinta doméstica sobre mesa, usada para instalação em rede",
    width: 1200,
    height: 630,
  },
  "como-conectar-wifi-tv-nao-conecta": {
    src: "/blog/como-conectar-wifi-tv-nao-conecta.jpg",
    alt: "Módulo Wi-Fi interno de uma Smart TV responsável pela conexão sem fio do aparelho",
    width: 1200,
    height: 630,
  },
  ...
  // ── Rodada 9B — pilares nacionais (fotografias reais licenciadas, Wikimedia Commons).
  "o-que-e-informatica": {
    src: "/blog/o-que-e-informatica.jpg",
    alt: "Fileira de computadores de mesa em um laboratório de informática escolar",
    width: 1200,
    height: 630,
  },
  "informatica-basica": {
    src: "/blog/informatica-basica.jpg",
    alt: "Estudante sentado diante de um computador de mesa durante uma aula de informática",
    width: 1200,
    height: 630,
  },
  "como-aprender-informatica": {
    src: "/blog/como-aprender-informatica.jpg",
    alt: "Estudantes trabalhando em uma atividade em conjunto no laboratório de informática",
    width: 1200,
    height: 630,
  },
