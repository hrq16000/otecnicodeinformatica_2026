  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        />
        <meta property="og:title" content="Diagnóstico em 60s — O Técnico de Informática" />
      ...
      <main className="container mx-auto max-w-3xl px-4 py-8">
        ...
        <aside className="mt-12 p-5 rounded-xl border border-border bg-muted/30 text-sm">
          ...
          A maior parte dos chamados se encaixa em um destes 15 padrões. Pré-classificar
