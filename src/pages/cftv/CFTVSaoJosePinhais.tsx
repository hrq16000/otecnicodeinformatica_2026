...
const CFTVSaoJosePinhais = () => (
  <CFTVCityTemplate
    ...
    localStats="O aumento populacional e comercial de São José dos Pinhais traz consigo desafios de segurança. Câmeras visíveis e gravação contínua ajudam a documentar movimentação em lojas, galpões e residências; o resultado depende do posicionamento e da cobertura definidos na avaliação."
  />
);
