    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-14 md:py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          {/* Ecossistemas: informática domina; correlatos fecham em peso secundário. */}
          <div className="space-y-12">
            {ECOSSISTEMAS.map((eco) => {
              const cards = eco.slugs
                    ...
                    {cards.map(({ slug, icon: Icon, blurb }) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <h4 className="font-heading text-lg font-bold text-foreground group-hover:text-[hsl(var(--accent))]">
                            {data.serviceName}
                          </h4>
