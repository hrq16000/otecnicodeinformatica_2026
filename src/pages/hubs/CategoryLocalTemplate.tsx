...
export const CategoryLocalTemplate = ({ categoryId, localSlug }: Props) => {
  ...
  const serviceSchema = {
    ...
    provider: { "@type": "LocalBusiness", name: "O Técnico de Informática", url: SITE_BASE_URL, telephone: WA_PHONE_E164, address: { "@type": "PostalAddress", addressLocality: "Curitiba", addressRegion: "PR", addressCountry: "BR" } },
...
export const CategoryHub = ({ categoryId }: { categoryId: CategoryId }) => {
  ...
  const hubSchema = {
    ...
    description,
    provider: { "@type": "LocalBusiness", name: "O Técnico de Informática", url: SITE_BASE_URL },
